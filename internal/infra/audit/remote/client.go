...
// Publish serializes the audit event and issues an HTTP POST to the configured endpoint.
func (c *Client) Publish(ctx context.Context, evt domain.AuditEvent) (retErr error) {
	if c == nil {
		return nil
	}
